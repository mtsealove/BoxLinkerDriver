...
public class LastOrderActivity extends AppCompatActivity {
    ...
    private void GetMyOrders() {
        ...
        Call<List<ResOrder>> call = restAPI.getRetrofitService().GetLastOrders(GetPhone());
        call.enqueue(new Callback<List<ResOrder>>() {
            ...
            public void onResponse(Call<List<ResOrder>> call, Response<List<ResOrder>> response) {
                if (response.isSuccessful()) {
                    MyOrderRecyclerAdapter adapter = new MyOrderRecyclerAdapter(LastOrderActivity.this);
